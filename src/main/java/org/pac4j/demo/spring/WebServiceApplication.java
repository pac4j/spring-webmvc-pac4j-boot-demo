...
import org.pac4j.springframework.controller.AbstractRestController;
...
@Controller
public class WebServiceApplication extends AbstractRestController {
    ...
    public String jwt(final Map<String, Object> map) {
        ...
        final Optional<CommonProfile> profile = getProfile(true);
